        ...
        <div className="mx-10 my-12">
            <div className="max-w-4xl py-3 border border-gray-500 rounded-xl shadow-xl md:mx-auto">
                ...
                <div className="flex flex-col px-2 py-4 gap-4 justify-center md:py-8 px-4">
                    ...
                    <input className="border border-gray-300 rounded-lg p-3 focus:border-[#547792] focus:border-outline-2" onChange={handleChange} type="text" placeholder="Please Enter Name"/>
                    <label htmlFor="Score" className="font-semibold text-lg text-[#547792]">Score</label>
                    <input className="border border-gray-300 rounded-lg p-3 focus:border-[#547792] focus:border-outline-2" onChange={handleChange} type="number" placeholder="Please Enter Score"/>
                    <label htmlFor="Match" className="font-semibold text-lg text-[#547792]">Match No.</label>
                    <input className="border border-gray-300 rounded-lg p-3 focus:border-[#547792] focus:border-outline-2" onChange={handleChange} type="number" placeholder="Please Enter Match Number"/>
                </div>
                <div className="my-3 text-end mx-5 flex gap-3 items-center justify-end">
                    ...
                    <Link className='font-bold text-lg text-[#547792] md:text-xl' to={"/Form"} onClick={handleForm}><FontAwesomeIcon icon="fa-solid fa-plus"/>ADD</Link>
                </div>
            </div>
        </div>
        </>
